...
export default function ImageCompressor() {
  ...
  const [imageInfo, setImageInfo] = useState<{
    original: { size: number; dimensions: string } | null;
    compressed: { size: number; dimensions: string } | null;
  } | null>(null);
            ...
            <Card>
              <CardBody>
                ...
                <div
                  ...
                  onClick={() =>
                    setPreviewModal({ isOpen: true, image: preview })
                  }
                >
                  <img
                    alt="原图"
                ...
                {imageInfo?.original && (
                  <p className="text-xs text-default-400 mt-2">
                    尺寸: {imageInfo.original.dimensions}
                    <br />
                ...
                {compressedImage && (
                  <>
                    ...
                    {imageInfo?.compressed && (
                      <p className="text-xs text-default-400 mt-2">
                        尺寸: {imageInfo.compressed.dimensions}
                        <br />
